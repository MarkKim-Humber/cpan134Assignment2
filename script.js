...
questionTwoButton.addEventListener("click", () => {
    ...
    questionTwoButton.style.backgroundColor = `rgb(${randomFunction(255)}, ${randomFunction(255)}, ${randomFunction(255)})`
});
...
//     firstItem.textContent = (Math.random()).toString(36).substring(2);
// });

// Selecting all "li" elements
const liItems = document.querySelectorAll("li");
// Iterating over the array to apply the .addEventListener() function to each item
liItems.forEach((li) => {
...
questionFour.addEventListener("click", () => {
    questionFour.style.backgroundColor = `rgb(${randomFunction(255)}, ${randomFunction(255)}, ${randomFunction(255)})`
})
